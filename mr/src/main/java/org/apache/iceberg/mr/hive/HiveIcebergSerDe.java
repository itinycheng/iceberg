...
public class HiveIcebergSerDe extends AbstractSerDe {
  ...
  private static Schema hiveSchemaOrThrow(Properties serDeProperties, Exception previousException,
    ...
    String columnNameDelimiter = serDeProperties.containsKey("column.name.delimiter") ?
        serDeProperties.getProperty("column.name.delimiter") : String.valueOf(SerDeUtils.COMMA);
